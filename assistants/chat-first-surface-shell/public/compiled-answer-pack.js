window.CHAT_FIRST_ANSWER_PACK = {
  "generatedAt": "2026-06-25T10:46:24.635Z",
  ...
  "answerRooms": [
    ...
    },
    {
      ...
      "answer": "The latest compiled event is Chatverse Public Identity. Events are not magic memory; they are structured records that can create route seeds only after compilation and validation.",
      "actions": [
        "event-ledger",
    ...
    },
    {
      ...
      "answer": "The latest receipt is Chatverse Public Identity. Receipts, logs, checksums, and validation gates are registered as project state so the shell can render proof instead of asking you to dig through the repo manually.",
      "actions": [
        "receipts-directory",
        "event-ledger",
        "compiler-report"
